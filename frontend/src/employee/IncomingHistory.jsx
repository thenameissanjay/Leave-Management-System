...
const ApprovalList = () => {
  ...
  if (!approvalData.length) return <div className="bg-white rounded-lg shadow p-8 text-center">No approval records found.</div>;
        ...
        <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="mb-4">
                ...
                <p className="text-sm bg-gray-50 p-3 rounded">{selectedRequest.comments || 'No comments'}</p>
              </div>

              {selectedRequest.approval_status === 100 && (
                <div className="mt-4">
                  <label className="block text-sm font-medium text-gray-700 mb-1">Your Comments (Optional)</label>
                  <textarea
                    rows="3"
