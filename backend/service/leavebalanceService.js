        ...
        leavePolicyPayloads.forEach( async (policy) => {
          ...
          leaves.forEach( (leave)=>{
              ...
              employees.forEach(async(emp)=>{
                  ...
                  const updateResult = await leaveBalanceRepo
                                      .createQueryBuilder()
                                      .update()
                                      .set({
...
const getBalanceLeave = async (employeeId, leave_type_id) => {
  try {
    ...
    const leaveBalances = await leaveBalanceRepo.find({
      ...
      relations: ["leave_type_dm"] // ← this uses your TypeORM defined relation
    });
...
module.exports = {updateLeaveBalanceByLeavetype, updateLeaveBalanceByEmployee,getLeaveTypeName,getBalanceLeave, updateLeaveBalanceByLeavePolicy}